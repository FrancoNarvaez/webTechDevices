...
describe('Opcion Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Personalizacion query and add missing value', () => {
      ...
      const personalizacion: IPersonalizacion = { id: 30314 };
      opcion.personalizacion = personalizacion;

      const personalizacionCollection: IPersonalizacion[] = [{ id: 8339 }];
    ...
    it('Should update editForm', () => {
      const opcion: IOpcion = { id: 456 };
      const personalizacion: IPersonalizacion = { id: 30202 };
      opcion.personalizacion = personalizacion;
