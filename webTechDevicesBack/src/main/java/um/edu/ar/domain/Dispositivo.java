...
public class Dispositivo implements Serializable {
    ...
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    @JsonIgnoreProperties(value = { "opcions", "opciones" }, allowSetters = true)
    ...
    public void setPersonalizaciones(Set<Personalizacion> personalizacions) {
        if (this.personalizaciones != null) {
            this.personalizaciones.forEach(i -> i.setOpciones(null));
        }
        if (personalizacions != null) {
            personalizacions.forEach(i -> i.setOpciones(this));
        }
    ...
    public void setAdicionales(Set<Adicional> adicionals) {
        if (this.adicionales != null) {
            this.adicionales.forEach(i -> i.setDispositivo(null));
        }
        if (adicionals != null) {
