...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, um.edu.ar.domain.Personalizacion.class.getName() + ".opcions");
            ...
            createCache(cm, um.edu.ar.domain.Venta.class.getName() + ".caracteristicas");
            createCache(cm, um.edu.ar.domain.Venta.class.getName() + ".personalizaciones");
            createCache(cm, um.edu.ar.domain.Venta.class.getName() + ".adicionales");
